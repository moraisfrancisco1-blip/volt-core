...
from .agents.dai_oakes_intelligence import start_dai_oakes_intelligence
from .agents.dai_oakes_marketing import start_dai_oakes_marketing
...
from .agents.dai_oakes_intelligence_router import router as dai_oakes_intelligence_router
from .agents.dai_oakes_marketing_router import router as dai_oakes_marketing_router
...
app.include_router(dai_oakes_intelligence_router)
app.include_router(dai_oakes_marketing_router)
...
def startup() -> None:
    bootstrap_admin(); start_monitoring(); run_controlled_self_test(); start_agent_inbox_worker(); start_production_monitor(); start_market_intelligence(); start_sales_agent(); start_deals_agent(); start_marketing_agent(); start_operations_agent(); start_backoffice_agent(); start_dai_oakes_intelligence(); start_dai_oakes_marketing(); start_customer_agent(); start_telegram_scheduler()
