...
def investigation_dict(record: AgentInvestigationRecord) -> dict:
    return {
        ...
        "proposed_files": record.proposed_files,
        "sandbox_status": record.sandbox_status,
        "sandbox_output": record.sandbox_output,
        "sandbox_network_isolated": record.sandbox_network_isolated,
        "sandbox_ran_at": record.sandbox_ran_at.isoformat() if record.sandbox_ran_at else None,
        "error": record.error,
