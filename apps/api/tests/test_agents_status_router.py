from app.agents import agent_inbox, deals_agent, market_intelligence, marketing_agent, operations_agent, production_monitor, sales_agent
...
def test_agents_status_returns_all_ten_agents_with_valid_states(monkeypatch):
    ...
    assert set(results.keys()) == {"volt", "dev_debug", "database", "finance", "production_monitor", "market_intelligence", "sales", "deals", "marketing", "operations"}
