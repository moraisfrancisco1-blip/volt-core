...
const NAV_ITEMS = [
  ...
  { label: 'Mapa de Topologia', viewId: 'topology', icon: <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><circle cx="12" cy="12" r="2.6" /><circle cx="5" cy="5" r="2" /><circle cx="19" cy="5" r="2" /><circle cx="5" cy="19" r="2" /><circle cx="19" cy="19" r="2" /><path d="M10.2 10.2 6.4 6.4M13.8 10.2l3.8-3.8M10.2 13.8l-3.8 3.8M13.8 13.8l3.8 3.8" /></svg> },
  { label: 'Funil de Vendas', viewId: 'funnel', icon: <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M3 4.5h18l-7 8.2v6.1l-4 2.2v-8.3z" /></svg> },
  { label: 'Organograma', viewId: 'orgchart', icon: <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><circle cx="12" cy="4.5" r="2.2" /><path d="M12 6.7v4" /><circle cx="5.5" cy="17" r="2.2" /><circle cx="12" cy="17" r="2.2" /><circle cx="18.5" cy="17" r="2.2" /><path d="M5.5 14.8v-2a1 1 0 0 1 1-1h11a1 1 0 0 1 1 1v2M12 10.7v2.1" /></svg> },
